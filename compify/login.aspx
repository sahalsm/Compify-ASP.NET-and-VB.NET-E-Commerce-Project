<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login.aspx.vb" Inherits="compify.login" %>
                     ...
                     <div class="mb-3">
                      ...
                      <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Password</label>
                             <asp:TextBox ID="TextBox2" type="password" class="form-control" runat="server" TextMode="Password" ></asp:TextBox>
                      </div>
                      <asp:Button ID="Button1" CssClass=" btn btn-success"  runat="server" Text="Login" />
                      <asp:Button ID="Button2" CssClass="btn btn-primary"  runat="server" Text="Register" />
                </form>
            </div>
            <div class="col-md-3"></div>
        </div>
